    ...
    return (
        <div className="right-panel">
            <ul className="instructions">
                ...
                <li>to quiz yourself on a specific word, click on the underlined headword in each card; once a lone card finishes loading, hover away or toward the card in order to flip the card</li>
